...
WebUI.callTestCase(findTestCase('Day1 - Scripting, Recording Types/Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Manoj'))
