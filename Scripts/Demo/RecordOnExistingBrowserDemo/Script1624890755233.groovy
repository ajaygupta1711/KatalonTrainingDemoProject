...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Triggered  AS'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_KPIs'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Triggered First Name'))
